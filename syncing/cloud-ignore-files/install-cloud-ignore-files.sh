...
cloud_path="${HOME}/Library/Mobile Documents/com~apple~CloudDocs/poetry"
...
ignore_files="node_modules,bower_components,*.log,.DS_Store,tmp"

# If you want, change log destination here (irellevant with --no-logs flag).
log_file="/var/log/unison-cloud-ignore-files.out.log"
err_file="/var/log/unison-cloud-ignore-files.err.log"
